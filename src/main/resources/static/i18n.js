...
(function () {
  var I18N = {
    ko: {
      'nav.login': '로그인', 'nav.signup': '회원가입', 'nav.quiz': '퀴즈봇',
      'nav.logout': '로그아웃', 'nav.withdraw': '회원 탈퇴',
      'quiz.who': '{name}님',
      'quiz.withdraw.confirm': '정말 탈퇴하시겠습니까?\n계정과 퀴즈 기록이 모두 삭제되며 되돌릴 수 없습니다.',
      'quiz.withdraw.done': '탈퇴가 완료되었습니다.',
      'quiz.withdraw.error': '탈퇴 처리 중 오류가 발생했습니다: ',
      'login.title': '로그인',
      ...
      'signup.field.name': '이름', 'signup.ph.name': '홍길동', 'signup.ph.password': '8자 이상',
    ...
    ja: {
      'nav.login': 'ログイン', 'nav.signup': '新規登録', 'nav.quiz': 'クイズ',
      'nav.logout': 'ログアウト', 'nav.withdraw': '退会',
      'quiz.who': '{name}さん',
      'quiz.withdraw.confirm': '本当に退会しますか？\nアカウントとクイズ履歴がすべて削除され、元に戻せません。',
      'quiz.withdraw.done': '退会が完了しました。',
      'quiz.withdraw.error': '退会処理中にエラーが発生しました: ',
      'login.title': 'ログイン',
      ...
      'signup.field.name': '名前', 'signup.ph.name': '山田 太郎', 'signup.ph.password': '8文字以上',
    ...
    en: {
      'nav.login': 'Log in', 'nav.signup': 'Sign up', 'nav.quiz': 'Quiz',
      'nav.logout': 'Log out', 'nav.withdraw': 'Delete account',
      'quiz.who': '{name}',
      'quiz.withdraw.confirm': 'Really delete your account?\nYour account and quiz history will be permanently removed.',
      'quiz.withdraw.done': 'Your account has been deleted.',
      'quiz.withdraw.error': 'Something went wrong while deleting your account: ',
      'login.title': 'Log in',
      ...
      'signup.field.name': 'Name', 'signup.ph.name': 'Jane Doe', 'signup.ph.password': '8+ characters',
